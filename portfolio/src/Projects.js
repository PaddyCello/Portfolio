    ...
    <>
      ...
      {!corn
        ...
        : <div className="blurb-holder animate__animated animate__slideInDown">
          ...
          <a href="https://github.com/PaddyCello/CornHub/blob/master/README.md" target="blank">[README]</a>
      ...
      {!ice
        ...
        : <div className="blurb-holder animate__animated animate__slideInDown">
          ...
          <a href="https://github.com/PaddyCello/SEI-Project-Three/blob/main/README.md" target="blank">[README]</a>
      ...
      {!worth
        ...
        : <div className="blurb-holder animate__animated animate__slideInDown">
          ...
          <a href="https://github.com/PaddyCello/IsItWorthIt/blob/master/README.md" target="blank">[README]</a>
      ...
      {!tetris
        ...
        : <div className="blurb-holder animate__animated animate__slideInDown">
          ...
          <a href="https://github.com/PaddyCello/SEI-Project-One/blob/main/README.md" target="blank">[README]</a>
