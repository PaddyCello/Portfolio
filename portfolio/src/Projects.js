  ...
  return (
    <>
      ...
      <Container className="carousel-container">
        <Carousel fade className="carousel animate__animated animate__zoomIn animate__slower">
      ...
      {!corn
        ? <> </>
        : <div className="blurb-holder animate__animated animate__slideInDown">
          <a href="http://cornhubapp.herokuapp.com/" target="blank"><h2>CornHub</h2></a>
          <a href="https://github.com/PaddyCello/CornHub/blob/master/README.md" target="blank"><h6>[README]</h6></a>
      ...
      {!ice
        ? <> </>
        : <div className="blurb-holder animate__animated animate__slideInDown">
          <a href="https://icelander.netlify.app/" target="blank"><h2>Icelander</h2></a>
          <a href="https://github.com/PaddyCello/SEI-Project-Three/blob/main/README.md" target="blank"><h6>[README]</h6></a>
      ...
      {!worth
        ? <> </>
        : <div className="blurb-holder animate__animated animate__slideInDown">
          <a href="https://isitworthit-hb.netlify.app/" target="blank"><h2>Is It Worth It?</h2></a>
          <a href="https://github.com/PaddyCello/IsItWorthIt/blob/master/README.md" target="blank"><h6>[README]</h6></a>
      ...
      {!tetris
        ? <> </>
        : <div className="blurb-holder animate__animated animate__slideInDown">
          <a href="https://paddycello.github.io/SEI-Project-One/" target="blank"><h2>Soviet Tetris</h2></a>
          <a href="https://github.com/PaddyCello/SEI-Project-One/blob/main/README.md" target="blank"><h6>[README]</h6></a>
